...
saveBtn.onclick = function() {
    var valueToSave = inputBox.value.replace(/<\/?[^>]+>/gi, ''); // Evitar etiquetas HTML

    localStorage.setItem('webStorageTestInput', valueToSave);

    storedTextContainer.innerHTML = "Se ha almacenado correctamente '" + valueToSave + "'. Actualice la página para que observe que el dato almacenado se muestra en el campo de formulario.";
}
